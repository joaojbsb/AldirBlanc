	...
	<section class="container acesso-rapido my-5 ">
      	...
      	<div class="row justify-content-center">
		  	...
		  	<div class="col-md-5 col-sm-6 border-dark text-center fundo-acesso-rapido">
				...
				<a href="<?php echo get_theme_mod('set_rapido_link16'); ?>"> <?php echo get_theme_mod('set_rapido_nome16'); ?></a> 
			</div>   
			...
			<div class="col-md-5 col-sm-6 border-dark text-center fundo-acesso-rapido">
				...
				?> 
				<a href="<?php echo get_theme_mod('set_rapido_link17'); ?>"> <?php echo get_theme_mod('set_rapido_nome17'); ?></a> 
